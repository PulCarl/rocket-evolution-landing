...
En quelques mots, sans jargon technique :

- **Page d'accueil** : présentation rapide, un gros bouton pour rejoindre le Discord, et le nombre de membres Discord affiché — mis à jour tout seul, sans qu'on ait à y toucher.
...
- **Mini-jeu** : un petit jeu façon "dinosaure de Google", aux couleurs de Rocket League — on saute par-dessus des obstacles, ça accélère avec le temps. On peut copier une image de son score pour la partager dans un salon Discord, et il y a aussi un vrai classement top 10 partagé entre tous les joueurs.
- Le site s'affiche bien aussi bien sur ordinateur que sur téléphone.

Rien n'est fait à la main au quotidien : les membres, les avis, les vidéos et le classement se mettent à jour tout seuls — la seule chose qui reste manuelle, c'est la validation des avis par un coach.
